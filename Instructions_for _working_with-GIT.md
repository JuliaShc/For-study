...
* git push - u origin main  - отправить изменения своей ветки в удаленный репозиторий (ключ -u -  --set-upstream - создание в удаденном репозитории ветки, соответствующей локальной ветки и их связывание)